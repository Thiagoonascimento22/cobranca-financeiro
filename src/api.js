...
export const api = {
  ...
  enviarDocumento: (id, arquivoBase64, mimetype, filename, legenda) => req("POST", "/api/cobranca/chats/" + id + "/send-document", { arquivoBase64, mimetype, filename, legenda }),
  ...
  elevenVozes: () => req("GET", "/api/cobranca/eleven-vozes"),
